...
public class SnakeGraphics {
	...
	public void initGraphics() {
		URL url = SnakeGraphics.class.getResource("/graphics/head.png");
		ImageIcon headIcon = new ImageIcon(url);
		
		url = SnakeGraphics.class.getResource("/graphics/dot.png");
		ImageIcon dotIcon = new ImageIcon(url);
		
		url = SnakeGraphics.class.getResource("/graphics/apple.png");
